...
const messages = {
  uz: {
    ...
    cancelTooLate: (hours) =>
      `Bronni tashrifdan kamida ${hours} soat oldin bekor qilish mumkin edi. Iltimos, sartaroshxonaga qo'ng'iroq qiling.`,
    ...
    adminCreated: "💈 <b>Siz uchun bron qo'shildi</b>",
  ...
  ru: {
    ...
    cancelTooLate: (hours) =>
      `Отменить запись можно было не позднее чем за ${hours} ч. до визита. Пожалуйста, позвоните в барбершоп.`,
    ...
    adminCreated: '💈 <b>Для вас создана запись</b>',
